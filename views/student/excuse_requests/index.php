        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo BASE_URL; ?>student/excuseRequests/viewRequest/<?php echo $request->id; ?>" class="btn btn-sm btn-info" data-bs-toggle="tooltip" title="View Request"><i class="fas fa-eye"></i></a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
